    ...
    <b-card>
      <div class="row">
        ...
        <div class="col-sm-7 hidden-sm-down">
          <b-button type="button" variant="primary" class="float-right"><i class="icon-cloud-download"/>
          </b-button>
      ...
      <div slot="footer">
        <ul>
          <li>
            ...
            <b-progress class="progress-xs mt-2" :precision="1" variant="success" :value="40"/>
          </li>
          <li class="d-none d-md-table-cell">
            <div class="text-muted">Unique</div>
            <strong>24.093 Users (20%)</strong>
            <b-progress class="progress-xs mt-2" :precision="1" variant="info" :value="20"/>
          </li>
          <li>
            <div class="text-muted">Pageviews</div>
            <strong>78.706 Views (60%)</strong>
            <b-progress class="progress-xs mt-2" :precision="1" variant="warning" :value="60"/>
          </li>
          <li class="d-none d-md-table-cell">
            <div class="text-muted">New Users</div>
            <strong>22.123 Users (80%)</strong>
            <b-progress class="progress-xs mt-2" :precision="1" variant="danger" :value="80"/>
          </li>
          <li class="d-none d-md-table-cell">
            <div class="text-muted">Bounce Rate</div>
            <strong>40.15%</strong>
            <b-progress class="progress-xs mt-2" :precision="1" :value="40"/>
          </li>
        </ul>
      </div>
    </b-card>
        ...
        <b-card header="Traffic &amp; Sales">
            ...
            <div class="col-sm-12 col-lg-4">
              ...
              <ul class="horizontal-bars">
                <li>
                  ...
                  <div class="bars">
                    <b-progress class="progress-xs" :value="34" variant="info"/>
                    <b-progress class="progress-xs" :value="78" variant="danger"/>
                  </div>
                </li>
                <li>
                  <div class="title">
                  ...
                  <div class="bars">
                    <b-progress class="progress-xs" :value="56" variant="info"/>
                    <b-progress class="progress-xs" :value="94" variant="danger"/>
                  </div>
                </li>
                <li>
                  <div class="title">
                  ...
                  <div class="bars">
                    <b-progress class="progress-xs" :value="12" variant="info"/>
                    <b-progress class="progress-xs" :value="67" variant="danger"/>
                  </div>
                </li>
                <li>
                  <div class="title">
                  ...
                  <div class="bars">
                    <b-progress class="progress-xs" :value="43" variant="info"/>
                    <b-progress class="progress-xs" :value="91" variant="danger"/>
                  </div>
                </li>
                <li>
                  <div class="title">
                  ...
                  <div class="bars">
                    <b-progress class="progress-xs" :value="22" variant="info"/>
                    <b-progress class="progress-xs" :value="73" variant="danger"/>
                  </div>
                </li>
                <li>
                  <div class="title">
                  ...
                  <div class="bars">
                    <b-progress class="progress-xs" :value="53" variant="info"/>
                    <b-progress class="progress-xs" :value="82" variant="danger"/>
                  </div>
                </li>
                <li>
                  <div class="title">
                  ...
                  <div class="bars">
                    <b-progress class="progress-xs" :value="9" variant="info"/>
                    <b-progress class="progress-xs" :value="69" variant="danger"/>
                  </div>
                </li>
                <li class="legend">
                  <span class="badge badge-pill badge-info"/>
                  <small>New clients</small> &nbsp; <span class="badge badge-pill badge-danger"/>
            ...
            <div class="col-sm-6 col-lg-4">
              ...
              <ul class="horizontal-bars type-2">
                <li>
                  ...
                  <div class="bars">
                    <b-progress class="progress-xs" :value="43" variant="warning"/>
                  </div>
                </li>
                <li>
                  ...
                  <div class="bars">
                    <b-progress class="progress-xs" :value="37" variant="warning"/>
                  </div>
                </li>
                <li class="divider"/>
                <li>
                  ...
                  <div class="bars">
                    <b-progress class="progress-xs" :value="56" variant="success"/>
                  </div>
                </li>
                <li>
                  ...
                  <div class="bars">
                    <b-progress class="progress-xs" :value="15" variant="success"/>
                  </div>
                </li>
                <li>
                  ...
                  <div class="bars">
                    <b-progress class="progress-xs" :value="11" variant="success"/>
                  </div>
                </li>
                <li>
                  ...
                  <div class="bars">
                    <b-progress class="progress-xs" :value="8" variant="success"/>
                  </div>
                </li>
            ...
            <div class="col-sm-6 col-lg-4">
              ...
              <ul class="icons-list">
                <li>
                  ...
                  <div class="actions">
                    <button type="button" class="btn btn-link text-muted"><i class="icon-settings"/>
                    </button>
                  </div>
                </li>
                <li>
          ...
          >
            ...
            <template slot="payment" slot-scope="item">
              <i :class="item.value.icon" style="font-size:24px"/>
            </template>
