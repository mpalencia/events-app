  ...
  methods: {
    submit: async function () {
      const {data} = typeof (this.id) === 'undefined'
        ? await this.form.post(`organizer/event/${this.eventId}/date-time/create`)
        : await this.form.put(`organizer/event/${this.eventId}/date-time/${this.id}/update`)
    ...
    fetchData () {
      ...
      axios.get(`organizer/event/${this.eventId}/date-time/${this.id}/edit`)
